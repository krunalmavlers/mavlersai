// Inline brand icons for social links. Add new platforms here and they become
// available in the admin dropdown (see PLATFORMS) and render automatically.
...
const PATHS: Record<string, string> = {
  ...
  x: 'M18.24 2.25h3.31l-7.23 8.26L23.11 21.75h-6.66l-5.22-6.82-5.97 6.82H1.95l7.73-8.84L.9 2.25h6.83l4.71 6.23 5.8-6.23zm-1.16 17.52h1.83L7.02 4.13H5.06l12.02 15.64z',
  facebook:
  ...
  github:
    'M12 .3a12 12 0 00-3.79 23.4c.6.1.82-.26.82-.58l-.01-2.02c-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.73.08-.73 1.2.09 1.84 1.24 1.84 1.24 1.07 1.83 2.81 1.3 3.5.99.11-.78.42-1.3.76-1.6-2.67-.3-5.47-1.33-5.47-5.93 0-1.31.47-2.38 1.24-3.22-.13-.3-.54-1.52.11-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 016 0c2.29-1.55 3.3-1.23 3.3-1.23.65 1.66.24 2.88.12 3.18.77.84 1.23 1.91 1.23 3.22 0 4.61-2.8 5.63-5.48 5.92.43.37.81 1.1.81 2.22l-.01 3.29c0 .32.22.69.83.57A12 12 0 0012 .3z',
};

export function SocialIcon({ platform, className }: { platform?: string; className?: string }) {
  const d = platform ? PATHS[platform] : undefined;
  if (!d) return null;
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className ?? 'h-[15px] w-[15px]'}>
      <path d={d} />
    </svg>
  );
}
