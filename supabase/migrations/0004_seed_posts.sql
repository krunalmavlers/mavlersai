...
values
  ('implementation','Automated client reporting for a MarTech agency','automated-client-reporting-martech',
   'A RAG-backed reporting pipeline replaced manual multi-source assembly across 40+ client accounts — delivered under the agency''s brand.',
   'published','2026-07-01','7 min', true,
   '<p>A fast-growing MarTech agency was drowning in monthly reporting. Analysts spent days assembling multi-source spreadsheets, and narrative quality varied by person.</p><h2>What we built</h2><p>A retrieval-augmented reporting pipeline that pulls from every connected data source, drafts a client-ready narrative, and routes it through a human approval step before delivery.</p><p>The system runs under the agency''s brand across more than 40 client accounts.</p>',
...
values
  ...
  ('insight','How we keep agency engagements invisible to end clients','white-label-invisible',
   'The operating practices that keep a delivery partner completely behind your brand.',
   'published','2026-06-25','7 min', false, '',
   '<p>Behind-the-scenes delivery only works if it is truly invisible. Here is how we operate behind your brand.</p><h2>Practices that matter</h2><p>Branded communication, NDAs, your tooling where possible, and clear ownership boundaries.</p>',
   '11111111-1111-1111-1111-111111111111'),
